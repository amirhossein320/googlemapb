...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Mahabad = new LatLng(36.7571092, 45.713091);
        mMap.addMarker(new MarkerOptions().position(Mahabad).title("Mahabad").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
        ...
        LatLng estakhre_abshar = new LatLng(36.7567721, 45.717045);
